...
class vgg_seg1:
    def __init__(self, x, y, seg_labels, obj_class, lam, keep_dropout, train_phase):
        self.logits_class, self.logits_seg = CNNModels2.VGG_Seg1(x, keep_dropout, train_phase, num_classes=100, num_seg_classes=176, random_init_seg_score_fr=True, debug=True)
